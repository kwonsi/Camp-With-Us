                ...
                $.ajax({
                    ...
                    success : function(rList){
                        ...
                        for(let reply of rList){
                            ...
                            const rvCampName = document.createElement("span");
                            rvCampName.classList.add("reply-campName");
                            rvCampName.innerText = reply.campName;
                            console.log("zzzzzzzzzz"+reply.campName);
                            ...
                            replyWriter.append(profileImage , memberNickname , replyDate, rvCampName, reviewListStar);
