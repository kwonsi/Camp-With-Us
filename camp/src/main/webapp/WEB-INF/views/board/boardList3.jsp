            ...
            <h3 style="margin-left:30px;"> "${param.query}" 검색 결과  </h3>
                        ...
                        <div class="myPageHeadFlex" id="myPageHeadFlexImg">
                            <div class="myPageHead">
                                ...
                                <span class="myPage-explanation"><span class="CWUspan">Camp With Us</span> 의 캠핑꿀팁을
                                    확인할 수 있습니다.</span>
                            </div>
                        </div>
                                            ...
                                            <c:forEach var="board" items="${boardList}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a
                                                            href="../detail/${boardCode}/${board.boardNo}?cp=${pagination.currentPage}${sURL}">${board.boardTitle}</a>
