                        ...
                        <div class="multiple-items">
                            ...
                            <c:forEach var="rdList" items="${placeRecommendList}">
                                <div class="slide-content">
                                    ...
                                    <div>
                                        <button class="slide-btn" style="margin-top: 15px;"
                                            onclick="window.open('${rdList.recommendHomepg}')">
                        ...
                        <div class="board-list">
                            <div class="board2-1">
                                ...
                                <div class="fb-page" data-href="https://www.facebook.com/go2thecamping/"
                                    data-tabs="timeline" data-width="500" data-height="400" data-small-header="true"
                                    data-adapt-container-width="true" data-hide-cover="true"
                                    data-show-facepile="true">
                                    <blockquote cite="https://www.facebook.com/go2thecamping/"
                                        class="fb-xfbml-parse-ignore"><a
                                            href="https://www.facebook.com/go2thecamping/">한국관광공사 고캠핑</a>
                                    </blockquote>
                                </div>
                            </div>
                            ...
                            <div class="multiple-items2 slide_div2">
                                <div class="slide-content2">
                                    <a><img src="${contextPath}/resources/images/board/ohcamall.png"
                                            onclick="window.open('https://www.ocamall.com/')"></a>
                                </div>
                                <div class="slide-content2">
                                    <a><img src="${contextPath}/resources/images/board/goossteoee.png"
                                            onclick="window.open('https://smartstore.naver.com/goossmall')"></a>
                                </div>
                                <div class="slide-content2">
                                    <a><img src="${contextPath}/resources/images/board/funshop.jpg"
                                            onclick="window.open('https://www.funshop.co.kr/goods/category/5716')"></a>
                                </div>
                                <div class="slide-content2">
                                    <a><img src="${contextPath}/resources/images/board/idoogen.jpg"
                                            onclick="window.open('https://idoogen.com/')"></a>
                                </div>
                            </div>
