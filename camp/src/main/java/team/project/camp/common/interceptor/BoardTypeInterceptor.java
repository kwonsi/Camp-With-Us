package team.project.camp.common.interceptor;
...
public class BoardTypeInterceptor implements HandlerInterceptor{
	// HandlerInterceptor 인터페이스는 default 로 작성되어있어서
	// @Override 하라는 오류가 뜨지 않음
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		// 이를 조회하는 Service 호출 후 결과를 세팅한다.

		// application scope 얻어오기
